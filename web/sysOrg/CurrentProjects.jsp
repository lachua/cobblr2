                        ...
                        <div class="row-fluid">
                            <div class="span12" id="col0">
                                <div class="box" id="box-0">
                                    <h4 class="box-header round-top">Current Projects</h4>
                                    <div class="box-container-toggle">
                                        <div class="box-content">
                                            <form method="POST" action="CurrentProjects">
                                            <%
                                            ...
                                            <table class="table table-striped table-bordered table-condensed" id="dtable">
                                                ...
                                                <tbody>
                                                    ...
                                                    for (int x = 0; x < currentProj.size(); x++) {
                                                        ...
                                                        List<OrgProjectEntity> partners = partnerdao.getpartners(currentProj.get(x).getProject_id() , user.getId());
                                                    %>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <%=currentProj.get(x).getStudent_firstname()%> <%=currentProj.get(x).getStudent_lastname()%><br>
