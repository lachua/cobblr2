...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Prohealth - Survey Accomplished</title>
                    ...
                    <div class="row-fluid">
                        <div class="span12 column" id="col0">
                            <div class="box" id="box-0">
                                <h4 class="box-header round-top">Project Closed</h4>
                                            ...
                                            <div class="control-group">
                                                <div class="controls">
                                                    <div class="span6 alert alert-info">
                                                        <strong>Thank you for serving the community.</strong>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="form-actions">
                                                <a href="SOrgHome" type="submit" class="btn btn-primary">Finish</a>
                                            </div>
                                        </fieldset>
                                        </form>
                                </div>
