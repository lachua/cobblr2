...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Prohealth - Add Equipments</title>
                        ...
                        <div class="row-fluid">
                            <div class="span12" id="col0">
                                <div class="box" id="box-0">
                                    <h4 class="box-header round-top">Add Equipment Requirements</h4>
                                    <div class="box-container-toggle">
                                        <div class="box-content">
                                            <form method="POST" action="Equipment" class="form-horizontal">
                                                <legend>New Equipment Requirement</legend>
                                                <div class="control-group">
                                                    <label class="control-label" for="title">Name of Equipment</label>
                                                    <div class="controls">
                                                        <input class="input-xlarge" name="title" id="title" type="text" placeholder="ex. Stetoscope, Thermometer" required/>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                ...
                                                <div class="form-actions">
                                                    <button name="action" value="add" type="submit" class="btn btn-primary">Add Equipment</button>
                                                    <a href="WorkStructureBack" type="button" class="btn">Back</a>
                                                </div>  
                                                <div class="control-group">
                                                    <legend>Current Equipment Requirements</legend>
