...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Prohealth - Medical Professionals</title>
                                ...
                                <div class="box" id="box-0">
                                    ...
                                    <div class="box-container-toggle">
                                        <div class="box-content">
                                            <form class="form-horizontal" method="POST" action="MedicalProfessionalsCOSCA">
                                                <div id="contactDetail" class="row-fluid">
                                                    <legend>New Medical Professional</legend>
                                                    ...
                                                    <div class="control-group">
                                                        <label class="control-label" for="desc">Specialization</label>
                                                        <div class="controls">
                                                            <input class="input-xlarge" name="desc" id="desc" type="text" placeholder="Doctor, Nurse" required/>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                ...
                                                <div class="form-actions">
                                                    <button id="add" name="add" type="button" class="btn btn-primary">Add New Professional</button>
                                                </div>  
                                            </form>
                                            <br/>

                                            <form method="POST" action="MedicalProfessionalsCOSCA">
