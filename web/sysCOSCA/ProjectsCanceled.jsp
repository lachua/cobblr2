...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Prohealth - Canceled Projects</title>
                        ...
                        <div class="row-fluid">
                            <div class="span12" id="col0">
                                <div class="box" id="box-0">
                                    <h4 class="box-header round-top">Canceled Projects</h4>
                                    <div class="box-container-toggle">
                                        <div class="box-content">
                                            <form method="POST" action="ProjectsCanceled">
                                            <%
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <%
                                                            ...
                                                            if (CompareDate.getDateDiff(projdate.getDate_cancelled(), TimeUnit.DAYS) < 3 && CompareDate.getDateDiff(projdate.getDate_cancelled(), TimeUnit.DAYS) >= 0) {
                                                        %>
                                                        <td><span class="badge badge-warning"><%=projdate.getDate_cancelled()%></span></td>
                                                            <%} else if (CompareDate.compareDates(projdate.getDate_cancelled()) < 0) {%>
                                                        <td><span class="badge badge-info"><%=projdate.getDate_cancelled()%></span></td>
                                                            <%} else {%>
                                                        <td><span class="badge badge-important"><%=projdate.getDate_cancelled()%></span></td>
                                                            <%}%>
                                                        <td>
                                                            <button name="ViewFullProjectCharter" value="<%=currentProj.get(x).getProject_id()%>" class="btn btn-default">Details</button>
                                                            <button name="WorkStructure" value="<%=currentProj.get(x).getProject_id()%>-<%=currentProj.get(x).getType()%>" class="btn btn-default">Tasks</button>
                                                        </td>
                                                    </tr>
                                                    <%}%>
                                                </tbody>
