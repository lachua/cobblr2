...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Prohealth - Approved Projects</title>
                        ...
                        <div class="row-fluid">
                            <div class="span12" id="col0">
                                <div class="box" id="box-0">
                                    <h4 class="box-header round-top">Approve Projects</h4>
                                    <div class="box-container-toggle">
                                        <div class="box-content">
                                            <form method="POST" action="ProjectsApproved">
                                            <%
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="badge badge-important"><%=projdate.getDate_target_implement()%></span></td>
                                                            <%}%>
                                                        <td>
                                                            <button  style="float: right;" name="Unapprove" value="<%=currentProj.get(x).getProject_id()%>" class="btn btn-danger">Un-Approve</button>
                                                        </td>
                                                    </tr>
                                                    <%}%>
                                                </tbody>
    ...
    ================================================== -->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                <%
                    String unapprove = (String) request.getAttribute("projunapprove");
                    if(unapprove != null){
                %>
                        alert("Project \"<%=unapprove%>\" has been unapproved");
                    <%}%>
