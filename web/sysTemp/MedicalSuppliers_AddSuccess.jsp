                    ...
                    <div class="row-fluid">    
                        <div class="span12 column" id="col0">
                            <div class="box" id="box-0">
                                <h4 class="box-header round-top">New Medical Supplier</h4>
                                <div class="box-container-toggle">
                                    <div class="box-content">
                                        <form class="form-horizontal">
                                            <fieldset>
                                                <legend> Medical Supplier </legend>
                                                <div class="control-group">
                                                    <label class="control-label">Company Name:</label>
                                                    <div class="controls">
                                                        <label class="control">John Doe Company</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <label class="control">Sales</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-actions">
                                                    <a href="MedicalSuppliers.jsp"type="submit" class="btn btn-primary">Finish</a>
                                                </div>
                                            </fieldset>
                                        </form>
                                    </div>
