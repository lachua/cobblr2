...
import dbentities.ReportChild2Entity;
 ...
 * @author Renliw
 */
public class ReportChild2DAO extends QueryTemplate{

    // projects per status
    public List<ReportChild2Entity> getReport(int community_id, Date start, Date end){
        setQuery("SELECT \n" +
                "    oa.answertext as 'age',\n" +
        ...
        List<ReportChild2Entity> results = executeQuery();
    ...
    protected Object storeResults(ResultSet rs) {
        ReportChild2Entity entity = new ReportChild2Entity();
