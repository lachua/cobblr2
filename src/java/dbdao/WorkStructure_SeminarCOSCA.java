 ...
 * @author Renliw
 */
public class WorkStructure_SeminarCOSCA extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getMethod().equals("GET")) {
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("/sysCOSCA/WorkStructure_Seminar.jsp");
