...
import dbentities.ReportChild7Entity;
 ...
 * @author Renliw
 */
public class ReportChild7DAO extends QueryTemplate{

    // projects per status
    public List<ReportChild7Entity> getReport(int community_id, Date start, Date end){
        setQuery("SELECT \n" +
                "    oa.answertext as 'Immunization',\n" +
        ...
        List<ReportChild7Entity> results = executeQuery();
    ...
    protected Object storeResults(ResultSet rs) {
        ReportChild7Entity entity = new ReportChild7Entity();

        try {
            entity.setImmunization(rs.getString("immunization"));
