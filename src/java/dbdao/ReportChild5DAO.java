...
import dbentities.ReportChild5Entity;
 ...
 * @author Renliw
 */
public class ReportChild5DAO extends QueryTemplate{

    // projects per status
    public List<ReportChild5Entity> getReport(int community_id, Date start, Date end){
        setQuery("SELECT \n" +
                "    oa.answertext as 'BMI',\n" +
        ...
        List<ReportChild5Entity> results = executeQuery();
    ...
    protected Object storeResults(ResultSet rs) {
        ReportChild5Entity entity = new ReportChild5Entity();

        try {
            entity.setBmi(rs.getString("bmi"));
