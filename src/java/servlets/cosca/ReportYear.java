 ...
 * @author Renliw
 */
public class ReportYear extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getMethod().equals("GET")) {
                UnavailableProjectDAO charterDAO = new UnavailableProjectDAO();
                List<UnavailableProjectEntity> charter = charterDAO.getAllProjectsTypeArraneDateDesc(ProjectCharterDAO.ACCOMPLISHED);
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("/sysCOSCA/ReportYear.jsp");
