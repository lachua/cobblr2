    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getMethod().equals("GET")) {
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("/sysOrg/ChangeDate.jsp");
                ...
                boolean addDB = fullCharterDAO.updateFullCharter(unavailableProj);
            ...
            Logger.getLogger(ChangeDate.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }
    }
