 ...
 * @author Renliw
 */
public class DisapprovedPending extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getMethod().equals("GET")) {
                ...
                UnavailableProjectEntity unavailableProj = unavailableProjDAO.getUnavailableProject(Integer.parseInt(project_id));

                request.setAttribute("unavailableProj", unavailableProj);
                session.removeAttribute("project_id");
                RequestDispatcher dispatcher = request.getRequestDispatcher("/sysCOSCA/DisapprovedPending.jsp");
