 ...
 * @author Renliw
 */
public class COSCAHome extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getMethod().equals("GET")) {
                ...
                List<NotificationEntity> notif = notifDAO.getNotifsCOSCA();

                request.setAttribute("USER", thisUser);
                request.setAttribute("notif", notif);
                RequestDispatcher dispatcher = request.getRequestDispatcher("/sysCOSCA/COSCAHome.jsp");
