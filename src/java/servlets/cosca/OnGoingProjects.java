 ...
 * @author Renliw
 */
public class OnGoingProjects extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getMethod().equals("GET")) {
                ...
                List<UnavailableProjectEntity> currentProj = unavailableProjDAO.getAllProjectsType(ProjectCharterDAO.ON_GOING);
                unavailableProjDAO = new UnavailableProjectDAO();
                List<UnavailableProjectEntity> currentProjList = unavailableProjDAO.getAllProjectsTypeCommunity(ProjectCharterDAO.ON_GOING);
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("/sysCOSCA/OnGoingProjects.jsp");
