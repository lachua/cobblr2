 ...
 * @author Renliw
 */
public class ProjectImplemented extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getMethod().equals("GET")) {
                ...
                List<UnavailableProjectEntity> closedProj = unavailableProjDAO.getAllProjectsType(ProjectCharterDAO.IMPLMENTED);
                unavailableProjDAO = new UnavailableProjectDAO();
                List<UnavailableProjectEntity> closedProjList = unavailableProjDAO.getAllProjectsTypeCommunity(ProjectCharterDAO.IMPLMENTED);
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("/sysCOSCA/ProjectImplemented.jsp");
