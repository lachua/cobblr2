 ...
 * @author Renliw
 */
public class ProjectsCanceled extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getMethod().equals("GET")) {
                ...
                List<UnavailableProjectEntity> currentProj = unavailableProjDAO.getAllProjectsType(ProjectCharterDAO.CANCELED);
                unavailableProjDAO = new UnavailableProjectDAO();
                List<UnavailableProjectEntity> currentProjList = unavailableProjDAO.getAllProjectsTypeCommunity(ProjectCharterDAO.CANCELED);
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("/sysCOSCA/ProjectsCanceled.jsp");
                ...
                if (request.getParameter("ViewFullProjectCharter") != null) {
                    ...
                    session.setAttribute("isCanceled", true);
