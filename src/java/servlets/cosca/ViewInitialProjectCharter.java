 ...
 * @author Renliw
 */
public class ViewInitialProjectCharter extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getMethod().equals("GET")) {
                int project_id = Integer.parseInt(request.getParameter("ViewProjectDetails"));
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("/sysCOSCA/ViewInitialProjectCharter.jsp");
