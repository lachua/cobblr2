 ...
 * @author Renliw
 */
public class DoctorsIncDec extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getMethod().equals("GET")) {
                ...
                List<TaskDetailsEntity> medicalProfessionalList = detailsDAO.getTask(task_id);

                request.setAttribute("medicalProfessionalList", medicalProfessionalList);
                request.setAttribute("title", title);

                if (action.equals("increase")) {
                    RequestDispatcher dispatcher = request.getRequestDispatcher("/sysOrg/DoctorsIncrease.jsp");
                    dispatcher.forward(request, response);
                } else if (action.equals("decrease")) {
                    RequestDispatcher dispatcher = request.getRequestDispatcher("/sysOrg/DoctorsDecrease.jsp");
                    dispatcher.forward(request, response);
                }
