 ...
 * @author Renliw
 */
public class ViewClosedProjectCharter extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getMethod().equals("GET")) {
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("/sysOrg/ViewClosedProjectCharter.jsp");
