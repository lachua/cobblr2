 ...
 * @author Renliw
 */
public class ViewInitialProjectCharterOrg extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getMethod().equals("GET")) {
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("/sysOrg/ViewInitialProjectCharter.jsp");
                dispatcher.forward(request, response);
            } else if (request.getMethod().equals("POST")) {
                response.sendRedirect("ContactDetails");
            }
        } finally {
            out.close();
        }
