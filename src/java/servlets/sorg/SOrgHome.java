 ...
 * @author Renliw
 */
public class SOrgHome extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getMethod().equals("GET")) {
                ...
                List<NotificationEntity> notif = notifDAO.getNotifsOrg(thisUser.getId());

                request.setAttribute("USER", thisUser);
                request.setAttribute("notif", notif);
                RequestDispatcher dispatcher = request.getRequestDispatcher("/sysOrg/SOrgHome.jsp");
                ...
                String id_notification = request.getParameter("action");

                NotificationDAO notifDAO = new NotificationDAO();
                boolean result = notifDAO.notificataionViewed(Integer.parseInt(id_notification));
