        ...
        try {
            if (request.getMethod().equals("GET")) {
                ...
                if (request.getParameter("action").equals("add")) {
                    RequestDispatcher dispatcher = request.getRequestDispatcher("/sysOrg/MedicineAdd.jsp");
                    dispatcher.forward(request, response);
                } else if (request.getParameter("action").equals("edit")) {
                    RequestDispatcher dispatcher = request.getRequestDispatcher("/sysOrg/MedicineEdit.jsp");
                    dispatcher.forward(request, response);
                }
                ...
                if (request.getParameter("action").equals("add")) {
                    ...
                    task.setResource_type(ProjectTaskDAO.MEDICINE);
