 ...
 * @author Renliw
 */
public class ProjectPendingDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getMethod().equals("GET")) {
                ...
                UnavailableProjectEntity unavailableProj = unavailableDAO.getPendingProjects(project_id);

                request.setAttribute("unavailableProj", unavailableProj);
                RequestDispatcher dispatcher = request.getRequestDispatcher("/sysOrg/ProjectPendingDetails.jsp");
