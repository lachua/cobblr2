...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Prohealth - Add Medical Professionals</title>
                        ...
                        <div class="row-fluid">
                            <div class="span12" id="col0">
                                <div class="box" id="box-0">
                                    <h4 class="box-header round-top">Add Medical Practitioners Requirements</h4>
                                    <div class="box-container-toggle">
                                        <div class="box-content">
                                            <form method="POST" action="Doctors" class="form-horizontal">
                                                <legend>New Medical Practitioners Requirement</legend>
                                                <div class="control-group">
                                                    <label class="control-label" for="title">Type of Medical Practitioners</label>
                                                    <div class="controls">
                                                ...
                                                <div class="form-actions">
                                                    <button name="action" value="add" type="submit" class="btn btn-primary">Add Medical Practitioners</button>
                                                    <a href="WorkStructureBack" type="button" class="btn">Back</a>
                                                </div>  
                                                <div class="control-group">
                                                    <legend>Current Medical Practitioners Requirements</legend>
