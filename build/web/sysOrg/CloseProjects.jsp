...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Prohealth - Close Project</title>
                        ...
                        <div class="row-fluid">
                            <div class="span12" id="col0">
                                <div class="box" id="box-0">
                                    <h4 class="box-header round-top">Close Projects</h4>
                                    <div class="box-container-toggle">
                                        <div class="box-content">
                                            <form method="POST" action="CloseProjects">
                                            <%
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button name="CloseSurvey" value="<%=closedProj.get(x).getProject_id()%>-<%=closedProj.get(x).getType()%>" class="btn btn-primary">Closing Survey</button>
                                                            <button name="ViewClosedProjectCharter" value="<%=closedProj.get(x).getProject_id()%>" class="btn btn-inverse">Details</button>
