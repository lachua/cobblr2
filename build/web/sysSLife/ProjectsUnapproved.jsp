...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Prohealth - Un-approved Projects</title>
                        ...
                        <div class="row-fluid">
                            <div class="span12" id="col0">
                                <div class="box" id="box-0">
                                    <h4 class="box-header round-top">Un-approved Projects</h4>
                                    <div class="box-container-toggle">
                                        <div class="box-content">
                                            <form method="POST" action="ProjectsUnapproved">
                                            <%
                                            ...
                                            <table class="table table-striped table-bordered table-condensed" id="dtable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%=currentProj.get(x).getOrg_name()%><br>
                                                            <ul>
                                                        ...
                                                        <td><span class="badge badge-important"><%=projdate.getDate_target_implement()%></span></td>
                                                            <%}%>
                                                        <td>
                                                            <button  style="float: right;" name="Approve" value="<%=currentProj.get(x).getProject_id()%>" class="btn btn-success">Approve</button>
                                                        </td>
                                                    </tr>
                                                    <%}%>
                                                </tbody>
    ...
    ================================================== -->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                <%
                    String approve = (String) request.getAttribute("projapprove");
                    if(approve != null){
                %>
                        alert("Project \"<%=approve%>\" has been approved");
                    <%}%>
