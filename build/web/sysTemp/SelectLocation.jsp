            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    ...
                    <div>
                        <ul class="breadcrumb">
                            <li>
                                Search Projects <span class="divider">/</span>
                            </li>
                            <li class="active">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="box" id="box-0">
                                <h4 class="box-header round-top">Select Location of Project</h4>
                                        ...
                                        <form class="form-horizontal">
                                            <fieldset>
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="city">Search City.</label>
                                                    <div class="controls">
                                                        <select id="city" class="chzn-select">
                                                            <option>All</option>
                                                            <option>Osmena</option>
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="project">Type Of Project</label>
                                                    <div class="controls">
                                                        <select id="project" class="chzn-select">
                                                            <option>All</option>
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="status">Status of Project</label>
                                                    <div class="controls">
                                                ...
                                                <div class="form-actions">
                                                    <a href="ViewAvailableProjects.jsp" type="submit" class="btn btn-primary">Search</a>
                                                    <a type=SOrgHome.jsp class="btn">Cancel</a>
                                                </div>
                                            </fieldset> 
                                        </form>
                                    </div>
