...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Prohealth - Closed Projects</title>
                        ...
                        <div class="row-fluid">
                            <div class="span12" id="col0">
                                <div class="box" id="box-0">
                                    <h4 class="box-header round-top">Projects Accomplished</h4>
                                    <div class="box-container-toggle">
                                        <div class="box-content">
                                            <form method="POST" action="ProjectsAccomplished">
                                            <%
                                            ...
                                            <table class="table table-striped table-bordered table-condensed" id="dtable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%=closedProj.get(x).getStudent_mobileno()%> <br>
                                                            <ul>
                                                            <%for (OrgProjectEntity partner : partners){ %>
