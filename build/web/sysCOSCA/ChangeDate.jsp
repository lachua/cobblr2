...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Prohealth - Change Date</title>
                        ...
                        <div class="row-fluid">
                            <div class="span12" id="col0">
                                <div class="box" id="box-0">
                                    <h4 class="box-header round-top">Change Date</h4>
                                    <div class="box-container-toggle">
                                        <div class="box-content">
                                            <form class="form-horizontal" method="POST" action="ChangeDate">
                                                <h2>Change Date of</h2>
                                                <div class="span12">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="input-large datepicker" style="width: 95%" id="date" name="date" value="<%=unavailableProj.getMeetingdate()%>"/>
                                                </div>
                                            </div>
                                            <div class="form-actions">
                                                <button type="submit" class="btn btn-primary">Change Implementation Date</button>
                                                <a href="CurrentProjects" type="button" class="btn">Back</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
