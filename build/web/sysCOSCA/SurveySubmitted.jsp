                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                <div class="box" id="box-0">
                                    <h4 class="box-header round-top">Select Location to Encode Survey</h4>
                                    <div class="box-container-toggle">
                                        <div class="box-content">
                                            <form class="form-horizontal" method="POST" action="SurveySubmitted">
                                                <fieldset>
                                                <%
                                                    SurveyResults surveyResult = (SurveyResults) request.getAttribute("surveyResult");
                                                    String community_name = (String) request.getAttribute("community_name");
                                                %>
                                                <legend>Survey Submitted</legend>
                                                <span class="badge badge-info">You have accomplished <%=surveyResult.getNumFamilies() %> survey forms for <%=community_name %>.</span><br/><br/>
                                                <div style="padding-left: 8px;" class="control-group">
                                                    <label>Would you like to add another Survey Entry?</label>
                                                    <a href="EncodeCommunitySurvey" class="btn btn-primary">Yes</a>
                                                    <a href="CommunitySurvey" class="btn">No</a>
                                                </div>
                                            </fieldset>
                                        </form>
                                    </div>
