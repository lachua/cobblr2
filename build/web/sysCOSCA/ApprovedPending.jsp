...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Prohealth - Approved Pending</title>
                                ...
                                <div class="box" id="box-0">
                                    ...
                                    <div class="box-container-toggle">
                                        <div class="box-content">
                                            <h2><strong>Project Confirmed.</strong></h2>
                                            <div class="span12">
                                        ...
                                        <h3><strong><%=unavailableProj.getOrg_name()%> can now officially start planning the project.</strong></h3>
