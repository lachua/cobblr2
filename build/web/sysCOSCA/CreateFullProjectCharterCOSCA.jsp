                                    ...
                                    <div class="box-container-toggle">
                                        <div class="box-content">
                                            ...
                                            <table class="table table-bordered">
                                                <tbody>
                                                    <tr>
                                                        <td>Project Title</td>
                                                        <td>
                                                            <label><%=unavailableProj.getTitle()%></label>
                                                            <input type="hidden" class="form-control" style="width: 95%" id="inputTitle" name="title" value="<%=unavailableProj.getTitle()%>"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Description</td>
                                                        <td> 
                                                            <label><%=unavailableProj.getDescription()%></label>
                                                            <input type="hidden" style="width: 95%" class="form-control" id="textArea" name="description" value="<%=unavailableProj.getDescription()%>"/>
                                                        </td>                                         
                                                    </tr>
                                                    <tr>
                                                        <td>Prepared By</td>
                                                        <td>
                                                            <label><%=unavailableProj.getPreparedby()%></label>
                                                            <input type="hidden" class="form-control" style="width: 95%" id="inputName" name="preparedby" value="<%=unavailableProj.getPreparedby()%>"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <h3>Project Objective</h3>
                                                            <label><%=unavailableProj.getObjectives()%></label>
                                            <input type="hidden" style="width: 95%" class="form-control" id="textArea" name="objective" value="<%=unavailableProj.getObjectives()%>">
                                            <br>
                                            ...
                                            %>
                                            <select required style="width: 95%" class="chzn-select" disabled multiple >
                                            ...
                                            <select style="width: 95%; display:none !important;" id="target_sickness" name="target_sickness" multiple >
                                                <optgroup label="If concerns below is not applicable:">
                                                    <option value="82" <%if(Compare.isProjectTarget(targets, 82)){%>selected<%}%>>Others</option>
                                                </optgroup>
                                                <optgroup label="Sicknesses:">
                                            ...
                                            %>
                                            <label><%=dateEntity.getTarget_participant_num()%></label>
                                            <input type="hidden" style="width: 95%" class="form-control" id="target_number" name="target_number" value="<%=dateEntity.getTarget_participant_num()%>"/>
                                            <br>
                                            <h3>Project Scope</h3>
                                            <label><%=unavailableProj.getScope()%></label>
                                            <input type="hidden" style="width: 95%" class="form-control" id="textArea" name="scope" value="<%=unavailableProj.getScope()%>"/>
                                            <br>
                                            <h3>Additional Requirements</h3>
                                            <label><%=unavailableProj.getRequirements()%></label>
                                            <input type="hidden" style="width: 95%" class="form-control" id="textArea" name="requirements" value="<%=unavailableProj.getRequirements()%>"/>
                                            <br>
