                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                <div class="box" id="box-0">
                                    <h4 class="box-header round-top">Account Edited</h4>
                                    <div class="box-container-toggle">
                                        <div class="box-content">
                                            <form class="form-horizontal" method="POST" action="SurveySubmitted">
                                                <fieldset>
                                                <legend>Account Edited</legend>
                                                <div style="padding-left: 8px;" class="control-group">
                                                    <label>Would you like to edit another Account?</label>
                                                    <a href="AccountEditSOrg" class="btn btn-primary">Yes</a>
